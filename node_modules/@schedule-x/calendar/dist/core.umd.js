(function (global, factory) {
  ...
  function MonthAgendaDay({ day, isActive, setActiveDate, isLeadingOrTrailing, }) {
      ...
      const monthAgendaDateDotsCCID = hooks.useState(monthAgendaDateDotsCustomComponent ? randomStringId() : '')[0];
      hooks.useEffect(() => {
  ...
  function MonthAgendaEvents({ events, customComponentKey, customContentKey, }) {
      const $app = hooks.useContext(AppContext);
      return (jsxRuntime.jsx("div", { className: "sx__month-agenda-events", children: events.length ? (events.map((event) => (jsxRuntime.jsx(MonthAgendaEvent, { calendarEvent: event, customComponentKey: customComponentKey, customContentKey: customContentKey }, event.id)))) : (jsxRuntime.jsx("div", { className: "sx__month-agenda-events__empty", children: $app.translate('No events') })) }));
  }
  ...
  function useAgenda($app, createGrid) {
      ...
      const [agenda, setAgenda] = hooks.useState(getAgenda());
      hooks.useEffect(() => {
          setAgenda(getAgenda());
      }, [
          $app.datePickerState.selectedDate.value,
  ...
  const MonthAgendaWrapper = ({ $app, id }) => {
      ...
      return (jsxRuntime.jsx(AppContext.Provider, { value: $app, children: jsxRuntime.jsxs("div", { id: id, className: "sx__month-agenda-wrapper", children: [jsxRuntime.jsx(MonthAgendaDayNames, { week: agenda.weeks[0] }), jsxRuntime.jsx("div", { className: "sx__month-agenda-weeks", children: agenda.weeks.map((week, index) => (jsxRuntime.jsx(MonthAgendaWeek, { week: week, setActiveDate: (date) => ($app.datePickerState.selectedDate.value = date), activeDate: $app.datePickerState.selectedDate.value, isLeadingOrTrailing: (date) => date.month !== selectedMonth }, index))) }), jsxRuntime.jsx(MonthAgendaEvents, { events: ((_a = agenda.weeks
                          .flat()
  ...
  const WeekAgendaWrapper = ({ $app, id }) => {
      ...
      return (jsxRuntime.jsx(AppContext.Provider, { value: $app, children: jsxRuntime.jsxs("div", { id: id, className: "sx__month-agenda-wrapper sx__week-agenda-wrapper", children: [jsxRuntime.jsxs("div", { className: "sx__week-agenda-header", children: [jsxRuntime.jsx(MonthAgendaDayNames, { week: agenda.weeks[0] }), jsxRuntime.jsx("div", { className: "sx__month-agenda-weeks", children: agenda.weeks.map((week, index) => (jsxRuntime.jsx(MonthAgendaWeek, { week: week, setActiveDate: (date) => ($app.datePickerState.selectedDate.value = date), activeDate: $app.datePickerState.selectedDate.value }, index))) })] }), jsxRuntime.jsx(MonthAgendaEvents, { events: ((_a = agenda.weeks
                          .flat()
  ...
  exports.createViewWeekAgenda = createViewWeekAgenda;
  ...
  exports.viewWeekAgenda = viewWeekAgenda;
